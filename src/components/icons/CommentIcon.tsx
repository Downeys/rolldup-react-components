...
export const CommentIcon = (props: IconProps) => <svg className={props.styling || 'h-6 w-6'} viewBox="0 0 24 24" fill={props.selected ? "#93CB56" : "none"} xmlns="http://www.w3.org/2000/svg">
