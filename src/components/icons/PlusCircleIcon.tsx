...
export const PlusCircleIcon = (props: IconProps) => <svg className={props.styling || "h-7 w-7"} viewBox="0 0 28 30" fill={props.selected ? "#93CB56" : "none"} xmlns="http://www.w3.org/2000/svg">
